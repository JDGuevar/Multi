...
public class FramePrincipal extends javax.swing.JFrame {
    ...
    private void initTaula(){
        ...
        dtm.setColumnIdentifiers(new String[]{"DNI/NIE","Nom", "Llinatge", "Alta", "Illa"});
    ...
    public void deleteClient(String doc){
        ...
        for (int i = 0; i < dtm.getRowCount(); i++){
            Object flag = dtm.getValueAt(i, 0);
            if (flag.equals(doc)){
                dtm.removeRow(i);
                break;
            }
    ...
    public boolean findClient(String doc){
    ...
    private void initComponents() {
        ...
        jMenu2.setText("Cositas");

        jMenuItem3.setText("Label summary");
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        DialogoAlta s = new DialogoAlta(this);
        s.setVisible(true);
    }//GEN-LAST:event_jMenuItem1ActionPerformed

    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        new DialogoBaja(this).setVisible(true);
