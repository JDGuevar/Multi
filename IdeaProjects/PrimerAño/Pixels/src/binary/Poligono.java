...
public class Poligono extends PixMap{
    double radio = 1.0, cx = 0.0, cy = 0.0;
    double[] vx, vy;
    int sides = 3;
    public Poligono(int width, int height, String filename) {
        super(width, height, filename);
        crearVeritices();
        Print();
    }

    public Poligono(int width, int height, String filename, double radio, int sides) {
        super(width, height, filename);
